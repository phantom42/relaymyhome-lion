relaymyhome-lion
===========
OSX Bash Script for automating the process of getting Nintendo 3DS StreetPass hits via Internet Connection Sharing. Adapted from the script by Rob Zimmerman to work on OSX 10.7.5 (Lion)
...
Installation & Usage (Mac OS X 10.7.5)
====================================
